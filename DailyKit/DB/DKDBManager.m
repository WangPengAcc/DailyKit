...
NSString * const identifier = @"DKDBidentifier";
...
{
    NSString *sqlFile = [[NSBundle mainBundle] pathForResource:fileName ofType:@"sql"];
    NSString *sql = [NSString stringWithContentsOfFile:sqlFile encoding:NSUTF8StringEncoding error:nil];
